...
export function createPage(newPage) {
  return function (dispatch) {
    return PagesApi.addPage(newPage).then((page) => {
...
export function destroyPage(id) {
  return function (dispatch) {
    return PagesApi.removePage(id).then((delPage) => {
...
export function fetchPage(id) {
  return function (dispatch) {
    return PagesApi.getPage(id).then((page) => {
...
export function startPageScraper(pageId) {
  return function (dispatch) {
    return PagesApi.crawlPage(pageId).then((page) => {
